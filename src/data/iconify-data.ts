export const ICONIFY_DATA = {
  ...
  mynaui: {
    ...
    samples: ["signal", "power", "tree", "cart", "filter", "cog-three"],
    height: 24,
    category: "UI 24px",
    tags: ["Has Padding", "Uses Stroke"],
    palette: false,
  ...
  pixelarticons: {
    ...
    samples: ["home", "arrows-horizontal", "heart", "tab", "hash", "folder"],
    height: 24,
    category: "UI 24px",
    tags: ["Precise Shapes", "Has Padding"],
    palette: false,
  ...
  "meteor-icons": {
    name: "Meteor Icons",
    total: 321,
    author: { name: "zkreations", url: "https://github.com/zkreations/icons" },
    license: {
      title: "MIT",
      spdx: "MIT",
  ...
  cuida: {
    ...
    total: 182,
    version: "1.18.0",
    author: { name: "Sysvale", url: "https://github.com/Sysvale/cuida-icons" },
    license: {
      title: "Apache 2.0",
      spdx: "Apache-2.0",
  ...
  "duo-icons": {
    ...
    total: 91,
    version: "1.1.4",
    author: { name: "fernandcf", url: "https://github.com/fazdiu/duo-icons" },
    license: {
      title: "MIT",
      spdx: "MIT",
  ...
  "svg-spinners": {
    ...
    height: 24,
    category: "UI 24px",
    tags: ["Precise Shapes", "Has Padding", "Contains Animations"],
    palette: false,
  },
  hugeicons: {
    name: "Huge Icons",
  ...
  stash: {
    name: "Stash Icons",
    total: 982,
    author: { name: "Pingback LLC", url: "https://github.com/stash-ui/icons" },
    license: {
      title: "MIT",
      spdx: "MIT",
  ...
  lineicons: {
    ...
    samples: ["check", "vuejs", "star-fat", "unsplash", "clipboard", "cart-2"],
    category: "UI 24px",
    tags: ["Has Padding"],
    palette: false,
  },
  ...
  jam: {
    name: "Jam Icons",
    total: 940,
    author: { name: "Michael Amprimo", url: "https://github.com/michaelampr" },
    license: {
      title: "MIT",
      spdx: "MIT",
  ...
  famicons: {
    name: "Famicons",
    total: 1342,
    author: { name: "Family", url: "https://github.com/familyjs/famicons" },
    license: {
      title: "MIT",
      spdx: "MIT",
  ...
  lsicon: {
    name: "Lsicon",
    total: 716,
    author: { name: "Wis Design", url: "https://www.lsicon.com/" },
    license: {
      title: "MIT",
      spdx: "MIT",
  ...
  "at-icons": {
    ...
    total: 400,
    author: {
      name: "Valentin Fossati",
      url: "https://github.com/Voxybuns/at-icons",
    },
    license: {
      title: "MIT",
      spdx: "MIT",
      url: "https://github.com/Voxybuns/at-icons/blob/main/LICENSE",
    },
    samples: ["shield", "checkerboard", "ladder", "sprout", "no-entry", "moon"],
    height: 16,
    category: "UI 16px / 32px",
    tags: ["Precise Shapes", "Has Padding"],
    palette: false,
  ...
  ix: {
    ...
    total: 1415,
    author: { name: "Siemens AG", url: "https://github.com/siemens/ix-icons" },
    license: {
      title: "MIT",
      spdx: "MIT",
  ...
  codex: {
    name: "CodeX Icons",
    total: 78,
    author: { name: "CodeX", url: "https://github.com/codex-team/icons" },
    license: {
      title: "MIT",
      spdx: "MIT",
  ...
  picon: {
    name: "Pico-icon",
    total: 824,
    author: { name: "Picon Contributors", url: "https://github.com/yne/picon" },
    license: {
      title: "Open Font License",
      spdx: "OFL-1.1",
      url: "https://github.com/yne/picon/blob/master/OFL.txt",
    },
    samples: ["bookmark", "rewind", "folder", "thunderbolt", "message", "east"],
    category: "UI Other / Mixed Grid",
    tags: ["Precise Shapes"],
    palette: false,
  },
  ...
  "streamline-stickies-color": {
    ...
    samples: ["mail", "love", "validation-1", "help", "graph-pie", "cursor"],
    category: "UI Multicolor",
    palette: true,
  },
  "fluent-color": {
  ...
  "material-icon-theme": {
    ...
    samples: ["zip", "email", "folder-upload", "stackblitz", "tree", "vscode"],
    category: "Programming",
    palette: true,
  },
  "file-icons": {
  ...
  twemoji: {
    name: "Twitter Emoji",
    total: 3988,
    author: { name: "Twitter", url: "https://github.com/jdecked/twemoji" },
    license: {
      title: "CC BY 4.0",
      spdx: "CC-BY-4.0",
      url: "https://creativecommons.org/licenses/by/4.0/",
  ...
  meteocons: {
    ...
    displayHeight: 16,
    category: "Thematic",
    tags: ["Uses Stroke", "Contains Animations"],
    palette: true,
  },
  healthicons: {
    name: "Health Icons",
  ...
  bx: {
    ...
    total: 814,
    version: "2.1.4",
    author: { name: "Boxicons", url: "https://github.com/box-icons/boxicons" },
    license: {
      title: "MIT",
      spdx: "MIT",
  ...
  "grommet-icons": {
    ...
    height: 24,
    category: "Archive / Unmaintained",
    tags: ["Precise Shapes", "Uses Stroke"],
    palette: false,
  },
  whh: {
  ...
  "fluent-emoji": {
    ...
    samples: ["avocado", "ticket", "straight-ruler"],
    height: 32,
    displayHeight: 16,
    tags: ["Precise Shapes", "Has Padding", "Uses Stroke"],
    palette: true,
