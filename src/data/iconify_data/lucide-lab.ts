...
export const LUCIDE_LAB: IconifyIconSet = {
  prefix: "lucide-lab",
  total: 373,
  title: "Lucide Lab",
  uncategorized: [
  ...
  aliases: {
    "chef-hat": "hat-chef",
    "circle-dollar-sign": "dollar-sign-circle",
    coffee: "mug",
    "concierge-bell": "bell-concierge",
    "flower-2": "flower-stem",
    grape: "grapes",
    "hard-hat": "hat-hard",
    home: "house",
    save: "floppy-disk",
    "save-all": "floppy-disks",
    shirt: "shirt-t",
    "square-code": "chevrons-left-right-square",
    utensils: "fork-knife",
