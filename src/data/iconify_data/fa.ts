...
export const FA: IconifyIconSet = {
  prefix: "fa",
  total: 678,
  ...
  aliases: {
    ...
    "battery-quarter": "battery-1",
    "battery-three-quarters": "battery-3",
    btc: "bitcoin",
    car: "automobile",
    deafness: "deaf",
    euro: "eur",
    ...
    gear: "cog",
    gears: "cogs",
    "google-plus-official": "google-plus-circle",
    gratipay: "gittip",
    "hand-rock-o": "hand-grab-o",
    "hand-stop-o": "hand-paper-o",
    "hard-of-hearing": "deaf",
    hotel: "bed",
    "hourglass-end": "hourglass-3",
    "hourglass-half": "hourglass-2",
    "hourglass-start": "hourglass-1",
    "id-card": "drivers-license",
    "id-card-o": "drivers-license-o",
    institution: "bank",
    jpy: "cny",
    legal: "gavel",
    "life-buoy": "life-bouy",
    "life-ring": "life-bouy",
    "life-saver": "life-bouy",
    link: "chain",
    "mobile-phone": "mobile",
    ...
    "sort-up": "sort-asc",
    "star-half-full": "star-half-empty",
    "star-half-o": "star-half-empty",
    support: "life-bouy",
    tachometer: "dashboard",
    taxi: "cab",
    "thermometer-4": "thermometer",
    "thermometer-empty": "thermometer-0",
    "thermometer-full": "thermometer",
    "thermometer-half": "thermometer-2",
    "thermometer-quarter": "thermometer-1",
    "thermometer-three-quarters": "thermometer-3",
    times: "close",
    ...
    users: "group",
    vcard: "address-card",
    "vcard-o": "address-card-o",
    warning: "exclamation-triangle",
    weixin: "wechat",
    "window-close": "times-rectangle",
    "window-close-o": "times-rectangle-o",
    won: "krw",
