  ...
  return (
    <div className="min-h-screen bg-green-50 dark:bg-slate-950 transition-colors">
      ...
      <div className="flex">
        ...
        <main className="flex-1 flex justify-center py-4 px-4 md:py-6 md:px-6 min-h-[calc(100dvh-64px-16px)] max-h-[calc(100dvh-64px-16px)] overflow-y-auto bg-slate-50 dark:bg-slate-950">
          {quizAtual ? (
            <Quiz
              quizData={quizAtual}
              tipo="manual"
