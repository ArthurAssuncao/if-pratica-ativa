...
export const OptionNode = memo(({ data }: NodeProps<OptionNodeData>) => {
  return (
    <div
      ...
      role="button"
      tabIndex={0}
      className="px-4 py-2 shadow-lg rounded-xl border-2 border-olive-400 bg-yellow-50 dark:bg-blue-500/10 
                 hover:border-green-500 hover:scale-105 transition-all cursor-pointer min-w-30 text-center max-w-30"
    >
